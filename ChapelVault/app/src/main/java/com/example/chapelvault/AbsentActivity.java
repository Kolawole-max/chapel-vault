...
public class AbsentActivity extends AppCompatActivity {
    ...
    private EmptyFragment absentFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        absentFragment = new EmptyFragment();
        presentFragment = new PresentFragment();

        tabLayout.setupWithViewPager(viewPager);

        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getSupportFragmentManager(), 0);
        viewPagerAdapter.addFragment(absentFragment, "Absent");
        viewPagerAdapter.addFragment(presentFragment, "Present");
